...
const events: DemoEvent[] = [
  ...
  { id: 'dlg-cto-full', type: 'dialogue', startMs: 10000, endMs: 26750, speaker: 'cto', text: "I reviewed 12,400 historical authorization decisions. Ninety-one percent follow six documented policy gates and can be processed inside our private environment. The remaining nine percent are exactly where clinical judgment changed the outcome." },
  { id: 'ev-cto', type: 'evidence', startMs: 10500, endMs: 42670, evidenceId: 'cto_history', action: 'show' },
  // Full stop: silence lands 1.5s before the governed refusal.
  { id: 'music-silence', type: 'music', startMs: 25470, bed: 'silence' },
  { id: 'sfx-decline', type: 'sound', startMs: 26770, soundId: 'safe-decline' },
  { id: 'safe-decline-on', type: 'safe-decline', startMs: 26770, endMs: 42360, active: true },
  { id: 'focus-escalation', type: 'visual-focus', startMs: 26770, target: 'escalation' },
  { id: 'dlg-cto-decline', type: 'dialogue', startMs: 27050, endMs: 42360, speaker: 'cto', text: 'One warning. I found no reliable precedent for peak-load throughput at the proposed volume. Confidence is below governance threshold. I am declining to answer. Recommended human reviewer: Vice President of Clinical Operations. Estimated review time: thirty-eight minutes.' },
  { id: 'ev-decline', type: 'evidence', startMs: 27270, endMs: 42670, evidenceId: 'safe_decline', action: 'show' },
  { id: 'esc-vp', type: 'escalation', startMs: 28670, escalationId: 'esc_vp_clinical', action: 'create' },
  { id: 'blk-scale-create', type: 'blocker', startMs: 29170, blockerId: 'blk_scale_precedent', action: 'escalate', status: 'escalated' },
  { id: 'safe-decline-off', type: 'safe-decline', startMs: 42670, active: false },
  ...
  { id: 'dlg-legal-full', type: 'dialogue', startMs: 94800, endMs: 106800, speaker: 'legal', text: "Three gates. One: patient data cannot touch a public cloud model. That rules out every external model evaluated last year. I have the governance memos and the rejection rationale." },
  ...
  { id: 'dlg-cfo-full', type: 'dialogue', startMs: 107000, endMs: 123644, speaker: 'cfo', text: "The board capped new-program spending at eleven million dollars this fiscal year. That motion passed seven to two in March. I preserved the dissent notes. Anything above the cap requires board approval Thursday, not after." },
  ...
  { id: 'dlg-buzz-close', type: 'dialogue', startMs: 215400, endMs: 223434, speaker: 'buzz', text: 'Executive Huddle ended. Duration: eight minutes, forty-two seconds. Equivalent scheduling delay avoided: twenty-one days.' },
